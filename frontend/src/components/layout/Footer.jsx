  ...
  return (
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/register" className="hover:text-gray-400 transition">Sign Up</Link></li>
              <li><Link to="/student/dashboard" className="hover:text-gray-400 transition">Browse Internships</Link></li>
              <li><a href="#" className="hover:text-gray-400 transition">Resources</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/register" className="hover:text-gray-400 transition">Post Internship</Link></li>
              <li><a href="#" className="hover:text-gray-400 transition">Pricing</a></li>
              <li><a href="#" className="hover:text-gray-400 transition">Success Stories</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-400 mt-8 pt-8 text-sm text-center text-gray-400">
